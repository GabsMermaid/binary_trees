 ...
 *
 * Return: 1 if node is a leafor 0 otherwise and if node is NULL return 0
 */
 ...
 *
 * @tree: points to root node of tree to be measured
 *
 * Return: height of tree and if tree is NULL return 0
 */
